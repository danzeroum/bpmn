...
/**
 * Handoff 8 §3 — dependency-graph acid test for `@bpmn-react/anchor-s3`.
 * Consumes ONLY `@bpmn-react/identity`; the S3 client is host-injected.
 */
...
describe('@bpmn-react/anchor-s3 dependency graph (Handoff 8 §3)', () => {
