...
/**
 * Handoff 8 §3 — dependency-graph acid test for `@buildtovalue/anchor-s3`.
 * Consumes ONLY `@buildtovalue/identity`; the S3 client is host-injected.
 */
...
describe('@buildtovalue/anchor-s3 dependency graph (Handoff 8 §3)', () => {
