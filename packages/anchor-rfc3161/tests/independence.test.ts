...
/**
 * Handoff 8 §3 — dependency-graph acid test for `@buildtovalue/anchor-rfc3161`.
 * Consumes ONLY `@buildtovalue/identity`; the TSA transport is host-injected.
 */
...
describe('@buildtovalue/anchor-rfc3161 dependency graph (Handoff 8 §3)', () => {
