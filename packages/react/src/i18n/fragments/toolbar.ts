...
export const toolbar: { en: Messages; ptBR: Messages } = {
  en: {
    ...
    'search.propertyTag': 'ref · property',
    ...
    'layout.title': 'Arrange diagram?',
    'layout.moved_one': '{count} node moved',
    'layout.moved_other': '{count} nodes moved',
    'layout.rerouted_one': '{count} edge re-routed',
    'layout.rerouted_other': '{count} edges re-routed',
    'layout.manual_one': '{count} manual route 📍 preserved',
    'layout.manual_other': '{count} manual routes 📍 preserved',
    'layout.apply': 'Apply',
    'layout.refuse': 'Refuse',
    'toolbar.undo': 'Undo',
  ...
  ptBR: {
    ...
    'search.resultsAria': 'Resultados da busca',
    'search.propertyTag': 'ref · propriedade',
    ...
    'layout.title': 'Arrumar diagrama?',
    'layout.moved_one': '{count} nó movido',
    'layout.moved_other': '{count} nós movidos',
    'layout.rerouted_one': '{count} aresta re-roteada',
    'layout.rerouted_other': '{count} arestas re-roteadas',
    'layout.manual_one': '{count} rota manual 📍 preservada',
    'layout.manual_other': '{count} rotas manuais 📍 preservadas',
    'layout.apply': 'Aplicar',
    'layout.refuse': 'Recusar',
