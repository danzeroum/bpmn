...
export const BUILT_IN_PALETTE: PaletteItem[] = [
  ...
  { id: 'sendTask', label: 'Send Task', nodeType: 'sendTask', icon: '✉' },
  { id: 'receiveTask', label: 'Receive Task', nodeType: 'receiveTask', icon: '📨' },
  { id: 'manualTask', label: 'Manual Task', nodeType: 'manualTask', icon: '✋' },
  ...
  { id: 'eventBasedGateway', label: 'Event Gateway', nodeType: 'eventBasedGateway', icon: '⬠' },
  { id: 'subProcess', label: 'Sub-Process', nodeType: 'subProcess', icon: '⧉' },
  { id: 'group', label: 'Group', nodeType: 'group', icon: '⬚' },
