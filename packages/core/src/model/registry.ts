...
export const BUILT_IN_NODE_TYPES: NodeTypeDefinition[] = [
  ...
  { type: 'sendTask', label: 'Send Task', category: 'activity', defaultSize: { width: 120, height: 60 }, xml: { tag: 'sendTask' } },
  { type: 'receiveTask', label: 'Receive Task', category: 'activity', defaultSize: { width: 120, height: 60 }, xml: { tag: 'receiveTask' } },
  { type: 'manualTask', label: 'Manual Task', category: 'activity', defaultSize: { width: 120, height: 60 }, xml: { tag: 'manualTask' } },
  { type: 'businessRuleTask', label: 'Business Rule Task', category: 'activity', defaultSize: { width: 120, height: 60 }, xml: { tag: 'businessRuleTask' } },
